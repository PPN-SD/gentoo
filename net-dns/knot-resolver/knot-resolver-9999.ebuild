...
if [[ ${PV} == 9999 ]]; then
	inherit git-r3
	EGIT_REPO_URI="https://gitlab.nic.cz/knot/knot-resolver.git"
...
pkg_postinst() {
	...
	optfeature_header "This package is very useful with Knot Resolver:"
	optfeature "asynchronous execution, especially with policy module" dev-lua/cqueues
	elog ""
	optfeature_header "There are several packages that may also be useful:"
